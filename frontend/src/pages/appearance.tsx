...
import { Palette, Image as ImageIcon, FileCode } from "lucide-react";

export const Appearance = () => {
    return (
        <div className="space-y-8">
            <h1 className="text-lg font-bold text-foreground">外観</h1>
            <section className="space-y-2" aria-labelledby="theme-heading">
                <h2 id="theme-heading" className="text-sm font-bold text-foreground">テーマ</h2>
                {/* a picture of the candidate window, not the candidate window */}
                <div className="flex items-start gap-x-4 pb-8" aria-hidden="true">
